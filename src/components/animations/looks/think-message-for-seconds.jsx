...
const ThinkMessageForSeconds = ({ message = "Hi", duration = 2, onChange, handleDeleteButton}) => {
    ...
    return (
        <div className="relative flex items-center justify-center  gap-2 bg-violet-600 px-4 py-3 rounded-xl font-medium">
